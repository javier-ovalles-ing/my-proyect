<x-layouts.app title="{{$post->title}}" meta-description="{{$post->body}}">
    ...
    <a class="mr-auto text-sm font-semibold underline border-2 border-transparent rounded dark:text-slate-300 text-slate-600 focus:border-slate-500 focus:outline-none" href="{{route('post.index')}}">Regresar</a>
    </div>
